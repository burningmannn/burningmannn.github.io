...
var en = {
    ...
    'description': '<b>About me:</b> I have experience of passing a six-month internship in web development as part of a team. I do sports and have no bad habits.',
    ...
    'description': '<b>О себе:</b> У меня есть опыт прохождения шестимесячной стажировки в области веб-разработки в составе команды. Я занимаюсь спортом и не имею вредных привычек.',
